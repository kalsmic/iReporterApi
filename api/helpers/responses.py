...
wrong_location = (
    "location must contain a both Latitude and Longitude coordinates and latitude must be between -90 and 90 "
...
wrong_password = (
    "Password Must contain a Minimum 8 characters with atleast one upper case letter, "
    "atleast on lower case letter and  atleast one number."
)
